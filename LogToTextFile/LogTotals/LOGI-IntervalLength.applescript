-- LOGI - Interval Length
-- Computes elapsed time between LOG2 (curtain down act 1) and LOG3 (curtain up act 2).
-- See LOGA for full notes on how this pattern works.

property mycue : "LOGI"
property startLogCue : "LOG2"
property endLogCue : "LOG3"
...
tell application id "com.figure53.QLab.4" to tell front workspace
	try
		...
		start cue writeCue
	on error errMsg
		display dialog "LOGI failed: " & errMsg buttons {"OK"} default button 1 with icon caution
	end try
end tell
