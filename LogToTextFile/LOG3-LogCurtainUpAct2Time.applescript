-- LOG3 - Log Curtain Up Time (Act 2 / Interval ends)
-- See LOG1 for how this system works.

property mycue : "LOG3"
property themessage : "Curtain Up Act 2"
...
tell application id "com.figure53.QLab.4" to tell front workspace
	try
		...
		start cue writeCue
	on error errMsg
		display dialog "LOG3 failed: " & errMsg buttons {"OK"} default button 1 with icon caution
	end try
end tell
