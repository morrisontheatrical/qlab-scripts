-- LOG2 - Log Curtain Down Time (Act 1 / Interval starts)
-- See LOG1 for how this system works.

property mycue : "LOG2"
property themessage : "Curtain Down Act 1"
...
tell application id "com.figure53.QLab.4" to tell front workspace
	try
		...
		start cue writeCue
	on error errMsg
		display dialog "LOG2 failed: " & errMsg buttons {"OK"} default button 1 with icon caution
	end try
end tell
